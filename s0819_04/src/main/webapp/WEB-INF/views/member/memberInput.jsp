...
<html>
	...
	<body>
	  ...
	  <form action="/member/member" method="post">
	    ...
	    <label>취미</label>
	    <input type="checkbok" name="hobby" id="게임" value="게임">
	    <label for="게임">게임</label>
	    <input type="checkbok" name="hobby" id="골프" value="골프">
	    <label for="골프">골프</label>
	    <input type="checkbok" name="hobby" id="수영" value="수영">
	    <label for="수영">수영</label>
	    <input type="checkbok" name="hobby" id="독서" value="독서">
	    <label for="독서">독서</label>
	    <input type="checkbok" name="hobby" id="조깅" value="조깅">
